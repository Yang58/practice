							...
							<fieldset>
								...
								<div class="agree">
									<h3 style="background: none; padding-left: 0">
										<input type="checkbox" name="all_check" id="all_check"
											...
											class="input_checkbox"><label for="all_check">사내 동호회 예약 사이트 가입 전체 이용약관 및 개인정보 수집 이용에 동의합니다.</label>
									</h3>
								</div>
								...
								<div class="agree">
									...
									<div class="agree_content" tabindex="0">
										<div>
											<h3>제1장 총칙</h3>
											<h4>제1조 (목적)</h4>
											<p class="indent2">이 약관은 서울특별시 강남구 (이하 "강남구"라 합니다) 문화체육강좌
												통합 사이트에서 제공하는 회원 서비스(이하 "서비스"라 합니다)를 이용함에 있어 이용자와 강남구간의
											...
											<ol class="indent2">
												...
												<li>강남구는 필요하다고 인정되는 경우 이 약관의 내용을 변경할 수 있으며, 변경된 약관은 서비스
												...
												<li>이용자는 변경된 약관에 동의하지 않으실 경우 서비스 이용을 중단하고 본인의 회원등록을 취소할
													...
													방법으로 효력이 발생합니다.</li>
												<li>이용자가 이 약관의 내용에 동의하는 경우 강남구의 서비스 제공행위 및 이용자의 서비스
											...
											<ol class="indent2">
												<li>이 약관에서 사용하는 용어의 정의는 다음과 같습니다.<br>① 이용자 : 서비스에
													접속하여 강남구가 제공하는 서비스를 받는 회원 및 비회원<br>② 회원 : 서비스에 접속하여 이
													약관에 동의하고, ID(고유번호)와 PASSWORD(비밀번호)를 발급 및 인증 등 확인 절차를 거친 자<br>③
													비회원 : 회원가입을 하지 않고 강남구가 제공하는 서비스를 이용하는 자<br>④ ID(고유번호)
													: 회원 식별과 회원의 서비스 이용을 위하여 이용자가 선정하고 강남구가 승인하는 영문자와 숫자의 조합<br>⑤
													PASSWORD(비밀번호) : 회원의 정보 보호를 위해 이용자 자신이 설정한 문자와 숫자의 조합<br>⑥
													이용해지 : 강남구 또는 회원이 서비스 이용 이후 그 이용계약을 종료시키는 의사표시
												</li>
											...
											<p class="indent2">이용계약은 이용자의 약관내용에 대한 동의와 이용자의 이용신청에 대한
												강남구의 승낙으로 성립합니다.</p>
											<h4>제5조 (이용신청)</h4>
											<p class="indent2">이용신청은 서비스의 회원정보 화면에서 이용자가 강남구에서 요구하는
												가입신청 양식에 개인의 신상정보를 기록하는 방식으로 신청합니다.</p>
											<h4>제6조 (이용신청의 수락과 거절)</h4>
											<ol class="indent2">
												<li>강남구는 제5조에서 정한 사항을 정확히 기재하여 이용신청을 하였을 경우 특별한 사정이 없는
													한 서비스 이용신청을 수락합니다.</li>
												<li>강남구는 다음 각 호에 해당하는 경우에 대하여는 그 신청에 대한 제한 사유가 해소될 때까지
													일부 서비스 이용을 제한할 수 있습니다.<br>① 내용이 허위(차명 등)인 것으로 판명되거나,
													그러하다고 의심할만한 합리적인 사유가 발생할 경우<br>② 기타 강남구가 필요하다고 인정되는 경우
												</li>
												<li>강남구는 다음에 해당하는 경우에는 이용신청을 제한할 수 있습니다.<br>① 다른
													사람의 명의를 사용하여 신청하였을 때<br>② 신청서의 내용을 허위로 기재하였을 때<br>③
													사회의 안녕 질서 또는 미풍양속을 저해할 목적으로 신청하였을 때<br>④ 기타 강남구가 정한
													이용신청 요건이 미비 되었을 때
												</li>
											</ol>
											<h4>제7조 (계약사항의 변경)</h4>
											...
											<h4>제8조 (서비스 이용)</h4>
											<ol class="indent2">
												<li>강남구는 회원의 이용신청을 수락한 때부터 서비스를 개시합니다. 단, 일부 서비스의 경우에는
													지정된 일자부터 서비스를 개시합니다.</li>
												<li>강남구의 업무상 또는 기술상의 장애로 인하여 서비스를 개시하지 못하는 경우에는 사이트에
													공시하거나 회원에게 이를 통지합니다.</li>
												<li>서비스의 이용은 연중무휴 1일 24시간을 원칙으로 합니다. 다만, 강남구의 업무상 또는
													기술상의 이유로 서비스가 일시 중지될 수 있고, 또한 정기점검 등 운영상의 목적으로 강남구가 정한 기간에는
													서비스가 일시 중지될 수 있습니다. 이러한 경우 강남구는 사전 또는 사후에 이를 공지합니다.</li>
												<li>회원에 가입한 후라도 일부 서비스 이용 시 서비스 제공자의 요구에 따라 특정 회원에게만
													서비스를 제공할 수도 있습니다.</li>
												<li>강남구는 서비스를 일정범위로 분할하여 각 범위별로 이용가능 시간을 별도로 정할 수 있습니다.
													이 경우 그 내용을 사전에 공지합니다.</li>
											</ol>
											<h4>제9조 (서비스의 변경, 중지 및 정보의 저장과 사용)</h4>
											<ol class="indent2">
												<li>회원은 본 서비스에 보관되거나 전송된 메시지 및 기타 통신 메시지 등의 내용이 국가의
													비상사태, 정전, 강남구의 관리범위 외의 서비스 설비 장애 및 기타 불가항력에 의하여 보관되지 못하였거나
													삭제된 경우, 전송되지 못한 경우 및 기타 통신 데이터의 손실에 대해 강남구가 아무런 책임을 지지 않음에
													동의합니다.</li>
												<li>강남구가 정상적인 서비스 제공의 어려움으로 인하여 일시적으로 서비스를 중지하여야 할 경우에는
													서비스 중지 1주일전에 고지 후 서비스를 중지할 수 있으며, 이 기간동안 회원이 고지내용을 인지하지 못한데
													대하여 강남구는 책임을 부담하지 아니합니다. 상당한 이유가 있을 경우 위 사전 고지기간은 감축되거나 생략될
													수 있습니다.<br>또한 위 서비스 중지에 의하여 본 서비스에 보관되거나 전송된 메시지 및 기타
													통신 메시지 등의 내용이 보관되지 못하였거나 삭제된 경우, 전송되지 못한 경우 및 기타 통신 데이터의
													손실이 있을 경우에 대하여도 강남구는 책임을 부담하지 아니합니다.
												</li>
												<li>강남구의 사정으로 서비스를 영구적으로 중단하여야 할 경우 제2항을 준용합니다. 다만, 이
													경우 사전 고지기간은 1개월로 합니다.</li>
												<li>강남구는 사전 고지 후 서비스를 일시적으로 수정, 변경 및 중단할 수 있으며, 이에 대하여
													회원 또는 제3자에게 어떠한 책임도 부담하지 아니합니다.</li>
												<li>강남구는 회원이 이 약관의 내용에 위배되는 행동을 한 경우, 임의로 서비스 사용을 중지할 수
													있습니다. 이 경우 강남구는 회원의 접속을 금지할 수 있으며, 회원이 게시한 내용의 전부 또는 일부를
													임의로 삭제할 수 있습니다.</li>
											...
											<ol class="indent2">
												<li>강남구는 회원이 서비스 이용 중 필요가 있다고 인정되는 다양한 정보 및 광고에 대해서는
													전자우편이나 서신우편, SMS(휴대폰 문자메시지), DM, 메신저 등의 방법으로 회원에게 제공할 수
													있으며, 만약 원치 않는 정보를 수신한 경우 회원은 이를 수신거부 할 수 있습니다.</li>
												<li>강남구는 서비스의 운용과 관련하여 서비스화면, 홈페이지, 전자우편 등에 광고 등을 게재할 수
													있으며, 강남구는 서비스를 이용하고자 하는 회원이 이 광고게재에 대하여 동의하는 것으로 간주합니다.</li>
												<li>강남구는 서비스 상에 게재되어 있거나 서비스를 통한 광고주와의 판촉활동에 회원이 참여하거나
													교신 또는 거래의 결과로서 발생하는 모든 손실 또는 손해에 대해 책임을 지지 않습니다</li>
											</ol>
											<h4>제11조 (게시물 또는 내용물의 삭제)</h4>
											<ol class="indent2">
												<li>강남구는 회원이 게시하거나 등록하는 서비스 내의 모든 내용물이 다음 각 호의 경우에
													해당된다고 판단되는 경우 사전 통지 없이 삭제할 수 있으며, 이에 대해 강남구는 어떠한 책임도 지지
													않습니다.<br>① 강남구, 다른 회원 또는 제3자를 비방하거나 중상 모략으로 명예를 손상시키는
													내용인 경우<br>② 공공질서 및 미풍양속에 위반되는 내용인 경우<br>③ 범죄적 행위에
													결부된다고 인정되는 내용일 경우<br>④ 제3자의 저작권 등 기타 권리를 침해하는 내용인 경우<br>⑤
													서비스 성격에 부합하지 않는 정보의 경우<br>⑥ 기타 관계 법령 및 강남구에서 정한 규정 등에
													위배되는 경우
												</li>
												<li>강남구는 서비스에 게시된 내용을 사전 통지된 지 3일 이후 편집, 이동, 삭제할 수 있는
													권리를 보유하며, 게시된 내용이 이 약관에 위배되거나 상용 또는 비합법적, 불건전한 내용일 경우 및 해지
													회원이 게시한 게시물은 사전통보 없이 삭제할 수 있습니다.</li>
												<li>강남구는 게시된 내용이 일정기간 이상 경과되어, 게시물로써의 효력을 상실하여 그 존치 목적이
													불분명한 경우 공지사항 발표 후 1주일간의 통지기간을 거쳐 해당 게시물을 삭제할 수 있습니다.</li>
											</ol>
											<h4>제12조 (게시물의 저작권)</h4>
											<ol class="indent2">
												<li>회원이 서비스 내에 게시한 게시물의 저작권은 회원에게 있으며, 강남구는 다른 서비스에서의
													개재 등 활용할 수 있습니다.</li>
											...
											<h4>제13조 (강남구의 소유권)</h4>
											<ol class="indent2">
												<li>강남구가 제공하는 서비스, 그에 필요한 소프트웨어, 이미지, 마크, 로고, 디자인,
													서비스명칭, 정보 및 상표 등과 관련된 지적재산권 및 기타권리는 강남구에게 소유권이 있습니다.</li>
												<li>회원은 강남구가 명시적으로 승인한 경우를 제외하고는 제1항 소정의 각 재산에 대한 전부 또는
											...
											<ol class="indent2">
												...
												<li>회원이 서비스 사용을 위한 가입절차를 완료하시면 아이디와 비밀 번호를 받게 됩니다. 회원의
													...
													발생되면 즉시 강남구에 신고하셔야 하고<br>② 매 접속 종료 시 확실히 로그아웃을 하셔야
													합니다.
												</li>
												<li>회원은 서비스를 이용하면서 다음과 같은 행위를 하지 않기로 동의합니다.<br>①
													...
													도달하게 하여 상대방의 일상적 생활을 방해하는 행위<br> 바. 강남구의 사전 승낙 없이 서비스를
											...
											<h4>제15조 (강남구의 의무)</h4>
											<ol class="indent2">
												<li>강남구는 특별한 사정이 없는 한 회원이 신청한 서비스 제공 개시일에 서비스를 이용할 수
													있도록 합니다.</li>
												<li>강남구는 이 약관에서 정한 바에 따라 계속적, 안정적으로 서비스를 제공할 의무가 있습니다.</li>
												<li>강남구가 제공하는 서비스로 인하여 회원에게 손해가 발생한 경우 그러한 손해가 강남구의 고의나
													중과실에 기해 발생한 경우에 한하여 강남구에서 책임을 부담하며, 그 책임의 범위는 통상손해에 한합니다.</li>
												<li>강남구는 회원으로부터 제기되는 의견이나 불만이 정당하다고 인정할 경우에는 신속히 처리하여야
													합니다. 다만, 신속한 처리가 곤란한 경우에는 회원에게 그 사유와 처리일정을 통보하여야 합니다.</li>
												<li>강남구는 관련법령이 정하는 바에 따라서 회원 등록정보를 포함한 회원의 개인정보를 보호하기
													위하여 노력합니다. 회원의 개인정보보호에 관해서는 관련법령 및 제 16조에 제시된 내용을 지킵니다.</li>
											</ol>
											<h4>제16조 (개인정보보호정책)</h4>
											<ol class="indent2">
												<li>강남구는 이용 신청 시 회원이 제공하는 정보를 통하여 회원에 관한 정보를 수집하며, 회원의
													개인정보는 본 이용계약의 이행과 본 이용계약상의 서비스제공을 위한 목적으로 이용합니다.</li>
												<li>강남구는 서비스 제공과 관련하여 취득한 회원의 정보를 본인의 승낙 없이 제3자에게 누설 또는
											...
											<ol class="indent2">
												<li>회원이 이용계약을 해지하고자 하실 때에는 회원 본인이 직접 인터넷을 통해 당 사이트에 해지
													신청을 하여야 합니다.</li>
												<li>강남구는 보안 및 아이디 정책, 서비스의 원활한 제공 등과 같은 이유로 회원의 ID 및
													PASSWORD 변경을 요구하거나 변경 할 수 있습니다.</li>
												<li>강남구는 회원이 다음 각 호에 해당하는 행위를 하였을 경우 사전통지 없이 이용계약을 해지할
													...
													저해하는 경우<br>⑦ 기타 관련법령이나 강남구가 정한 이용조건에 위배되는 경우
												</li>
											</ol>
											<h3>제6장 기타</h3>
											...
											<h3>제7장 손해배상 등</h3>
											<h4>제20조 (손해배상)</h4>
											<p class="indent2">강남구는 무료로 제공되는 서비스와 관련하여 회원에게 어떠한 손해가
												발생하더라도 동 손해가 강남구의 중대한 과실에 의한 경우를 제외하고 이에 대하여 책임을 부담하지 아니합니다.</p>
											<h4>제21조 (면책조항)</h4>
											<ol class="indent2">
												<li>강남구는 천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는
													서비스 제공에 관한 책임이 면제됩니다.</li>
												<li>강남구는 회원의 귀책사유로 인한 서비스이용의 장애에 대하여 책임을 지지 않습니다.</li>
												<li>강남구는 회원이 서비스를 이용하여 기대하는 이익이나 서비스를 통하여 얻은 자료로 인한 손해에
													관하여 책임을 지지 않습니다.</li>
												<li>강남구는 회원이 서비스에 게재한 정보, 자료, 사실의 신뢰도, 정확성 등의 내용에 관하여는
													책임을 지지 않습니다.</li>
											</ol>
											<h4>제22조 (관할법원)</h4>
											<ol class="indent2">
												<li>서비스 이용과 관련하여 강남구와 회원 사이에 분쟁이 발생한 경우, 강남구와 회원은 발생한
													분쟁을 원만하게 해결하기 위하여 필요한 모든 노력을 하여야 합니다</li>
												<li>제1항의 규정에도 불구하고 서비스 이용으로 발생한 분쟁에 대하여 소송이 제기될 경우 강남구
									...
									<div class="agree_content" tabindex="0">
										<div>
											...
											<p class="indent2">강남구 문화체육강좌 통합 사이트에서는 기본적인 회원 서비스 제공을
											...
											<h5>나. 개인정보 수집방법</h5>
											<p class="indent3">강남구 문화체육강좌 통합 사이트 회원가입을 통한 수집</p>
											<h4>2. 개인정보의 수집·이용목적 및 보유·이용기간</h4>
											<p class="indent2">강남구 문화체육강좌 통합 사이트에서는 정보주체의 회원 가입일로부터
											...
											<p class="indent2">
												정보주체는 개인정보의 수집·이용목적에 대한 동의를 거부할 수 있으며, 동의 거부시 강남구 문화체육강좌 통합
												사이트에 회원가입이 되지 않으며, 강남구 문화체육강좌 통합 사이트에서 제공하는 서비스를 이용할 수 없습니다.<br>
											</p>
										</div>
									</div>
									<div class="agree_checkbox">
									...
									<div class="agree_content" tabindex="0">
										<div>
											<p class="indent1">강남구 문화체육강좌 통합사이트에서는 아래의 경우 개인정보보호법
												...
												<table class="table1 all_border indent1"
													...
													<tbody>
														...
														<tr>
															...
															<td>강남문화재단강남구도시관리공단</td>
															<td>서울특별시 강남구 삼성로 628(삼성동66)</td>
											...
											<p class="indent1">정보주체는 개인정보 처리 및 위탁에 관한 동의 처리를 거부할 수
												있으며, 동의 거부시 강남구 문화체육강좌 통합 사이트에 회원가입이 되지 않으며, 강남구 문화체육강좌 통합
								...
								<p class="order_box">
									<a href="javascript:void(0)"
										onclick="$(this).parents('form').submit()" class="true">동의</a>
										<a href="javascript:void(0)"
										onclick="$(this).parents('form').submit()" class="true">취소</a>
								</p>
							</fieldset>
						</form>
					</div>
